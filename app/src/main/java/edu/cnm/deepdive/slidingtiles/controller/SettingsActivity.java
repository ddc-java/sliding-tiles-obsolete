...
public class SettingsActivity extends AppCompatActivity {
  ...
  public static class SettingsFragment extends PreferenceFragmentCompat implements Target {
    ...
    private void setupImagePreferences() {
      ...
      File directory = getContext().getDir(getString(R.string.image_subdirectory), MODE_PRIVATE);
